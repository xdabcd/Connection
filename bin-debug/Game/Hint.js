...
var Hint = (function (_super) {
    ...
    p.show1 = function (spriteName, anchorX, anchorY) {
        var _this = this;
        ...
        tw4.callBack = function () { return _this.destroy(); };
        tw4.start();
    };
    p.show2 = function (spriteName, anchorX, anchorY) {
        var _this = this;
        if (anchorX === void 0) { anchorX = 0.5; }
        if (anchorY === void 0) { anchorY = 0.5; }
        this._sprite.texture = RES.getRes(spriteName);
        ...
        tw2.callBack = function () { return _this.destroy(); };
        tw2.start();
    };
    p.show3 = function (spriteName, anchorX, anchorY) {
        var _this = this;
        if (anchorX === void 0) { anchorX = 0.5; }
        if (anchorY === void 0) { anchorY = 0.5; }
        this._sprite.texture = RES.getRes(spriteName);
        ...
        tw1.updateFunc = function () {
            if (_this._sprite.alpha > 1) {
