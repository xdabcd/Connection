...
var BaseController = (function () {
    ...
    p.applyControllerFunc = function (controllerKey, key) {
        ...
        return ControllerManager.instance.applyFunc.apply(ControllerManager.instance, arguments);
    };
    /**
     * 设置该模块使用的Model对象
     * @param model
    ...
    p.getControllerModel = function (controllerD) {
        return ControllerManager.instance.getControllerModel(controllerD);
    };
