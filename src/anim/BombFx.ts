...
class BombFx extends Fx {

    private f1:BombElement;
    private f2:BombElement;
    private f3:BombElement;
    private f4:BombElement;
    private f5:BombElement;
    private f6:BombElement;
    private f7:BombElement;
    private f8:BombElement;

    private glowF:egret.Bitmap;
    private white:egret.Shape;


    public static FLYDISTANCE:number = 0;

    public static TIME_ROTATION:number = 100;
    public static TIME_FLY:number = 200;
